    ...
    <div id={s.container}>
      <div id={s.content}>
        ...
        <div id={s.right_content}>
          ...
          <p className={s.text} id={s.fourth_text}>
          ...
          <p className={s.text} id={s.sixth_text}>
